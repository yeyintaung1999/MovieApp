...
//
//   let serieDetailResponse = try? newJSONDecoder().decode(SerieDetailResponse.self, from: jsonData)

import Foundation

// MARK: - SerieDetailResponse
public struct SerieDetailResponse: Codable {
    let adult: Bool?
    ...
    let seasons: [Season]?
    let spokenLanguages: [SpeakLanguage]?
